...
from models.vector_store import VectorStore  # New module
from services.azure_storage_service import AzureStorage  # New module
from services.gemini_service import GeminiService        # New module                     # New config file
import os
...
def upload_document():
    try:
        ...
        try:
            ...
            logger.debug("File uploaded to Azure Blob Storage")
        except Exception as e:
